            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Hᴇᴀʟᴛʜ", url="https://graph.org/Rem-has-bot-access-levels-we-call-as-Disaster-Levels-11-10"
                            ),
                            InlineKeyboardButton(
                                "Dɪꜱᴀꜱᴛᴇʀ", url="https://graph.org/Rem-has-bot-access-levels-we-call-as-Disaster-Levels-11-10-2"
                            ),
                        ],
                    ]
                ),
